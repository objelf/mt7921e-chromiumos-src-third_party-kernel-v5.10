...
/* CCU: Fake larb29 */
#define M4U_PORT_L29_CAM_CCU_AXI0		MTK_M4U_ID(29, 0)

/* CCU: Fake larb30 */
#define M4U_PORT_L30_CAM_CCU_AXI1		MTK_M4U_ID(30, 0)

/* APU: Fake larb31 */
#define M4U_PORT_L31_APU_CODE			MTK_M4U_ID(31, 0)
#define M4U_PORT_L31_APU_DATA			MTK_M4U_ID(31, 1)
#define M4U_PORT_L31_APU_VLM			MTK_M4U_ID(31, 2)

/* perfi */
#define M4U_PORT_INFRA_PCIE1_R			MTK_IOMMU_PERI_ID(0, 16)
#define M4U_PORT_INFRA_PCIE1_W			MTK_IOMMU_PERI_ID(0, 17)
#define M4U_PORT_INFRA_PCIE0_R			MTK_IOMMU_PERI_ID(0, 18)
#define M4U_PORT_INFRA_PCIE0_W			MTK_IOMMU_PERI_ID(0, 19)
#define M4U_PORT_INFRA_SSUSB_P3_R		MTK_IOMMU_PERI_ID(0, 20)
#define M4U_PORT_INFRA_SSUSB_P3_W		MTK_IOMMU_PERI_ID(0, 21)
#define M4U_PORT_INFRA_SSUSB_P2_R		MTK_IOMMU_PERI_ID(0, 22)
#define M4U_PORT_INFRA_SSUSB_P2_W		MTK_IOMMU_PERI_ID(0, 23)
#define M4U_PORT_INFRA_SSUSB_P1_1_R		MTK_IOMMU_PERI_ID(0, 24)
#define M4U_PORT_INFRA_SSUSB_P1_1_W		MTK_IOMMU_PERI_ID(0, 25)
#define M4U_PORT_INFRA_SSUSB_P1_0_R		MTK_IOMMU_PERI_ID(0, 26)
#define M4U_PORT_INFRA_SSUSB_P1_0_W		MTK_IOMMU_PERI_ID(0, 27)
#define M4U_PORT_INFRA_SSUSB2_R			MTK_IOMMU_PERI_ID(0, 28)
#define M4U_PORT_INFRA_SSUSB2_W			MTK_IOMMU_PERI_ID(0, 29)
#define M4U_PORT_INFRA_SSUSB_R			MTK_IOMMU_PERI_ID(0, 30)
#define M4U_PORT_INFRA_SSUSB_W			MTK_IOMMU_PERI_ID(0, 31)
